...
**Answer** I loaded a data set of NBA players in order of their rankings, positions and numerous other statistics about their season.
...
**Answer** A table with each position and the total number of players in each of those positions
...
**Answer** Some players are identified as having two positions with a hyphen, so that might impact the accurate total number of players in each position
...
**ANSWER** Power forwards have the highest average minutes played, but it would be interesting to compare minutes played to points scored to assess the importance/impact of each position in scoring
