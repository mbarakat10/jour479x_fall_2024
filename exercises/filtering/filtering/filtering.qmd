...
**ANSWER** Who do you get as the first result, and what was his trueshooting percentage? **TJ NeSmith, 78.52%**
...
Now it's your turn: do the same for the 2023 data. Load it from GitHub, then adapt the above code but add an additional filter to restrict the results to Maryland's first five games (the 5th game was on Aug. 31, 2023). You need to put the date value in quotes.
...
**ANSWER** Now how do the two years compare? **The team had more attempts in the 2024 season but nearly the same amount on goal, so the percentage of shots on goal from total attempts is greater by about 6% in the 2023 season.**
